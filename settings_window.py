...
def settings(root):
    ...
    lang = tk.StringVar(value=config['Settings']['lang'])
    ...
    settings_window.grab_set()  # このウインドウを閉じる処理の中で destroy() の前に grab_release() を実施
